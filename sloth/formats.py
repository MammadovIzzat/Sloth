...
TASK_FORMATS = [
    ...
    },
    {
        ...
        "coming_soon": True, "needs_key": True,
        ...
        "fields": [
            {"label": "Domain", "ph": "acme.example", "hint": "Subdomains are included automatically.", "font": "mono", "span": "span 2"},
            {"label": "Max pages", "ph": "5", "hint": "100 results per page, 1 credit each.", "font": "mono", "span": "auto"},
            {"label": "Facet", "ph": "org,port,country", "hint": "", "font": "mono", "span": "auto"},
        ],
    ...
    },
    {
        ...
        "fields": [
            {"label": "Domain", "ph": "acme.example", "hint": "Subdomains and every path under them are included automatically.", "font": "mono", "span": "span 2"},
        ],
        "opts": [],
    },
    {
        ...
        "fields": [
            {"label": "Endpoints", "ph": "auto — 443/tcp and 8080/tcp hosts", "hint": "Or paste your own list, one URL per line.", "font": "body", "span": "span 2"},
            {"label": "Timeout (s)", "ph": "10", "hint": "", "font": "mono", "span": "auto"},
            {"label": "User agent", "ph": "sloth/{version}", "hint": "", "font": "mono", "span": "auto"},
        ],
    ...
    },
    {
        ...
        "fields": [
            {"label": "Start URL", "ph": "https://acme.example", "hint": "", "font": "mono", "span": "span 2"},
            {"label": "Crawl depth", "ph": "2", "hint": "Depth 3+ gets slow on large sites.", "font": "mono", "span": "auto"},
            {"label": "Rule set", "ph": "secrets, endpoints", "hint": "Or write your own regex below.", "font": "body", "span": "auto"},
            {"label": "Custom regex", "ph": "(?:api[_-]?key|secret|token)\\s*[:=]", "hint": "PCRE. Capture groups are highlighted in results.", "font": "mono", "span": "span 2"},
        ],
